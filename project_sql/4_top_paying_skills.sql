...
Question: What are the top skills based on salary?
    ...
    - Why? It reveals how different skills impact salary levels for a Data Analyst and
           helps identify the most financially rewarding skill to aquire or improve
*/
...
/* 
  CHAT GPT interpretation for JSON

  - High Demand for Big Data and ML Skills : PySpark, Pandas
  - Software Development & Deployment Proficiency : GitLab, Kubernetes
  - Cloud Computing Expertise : Elasticsearch, Databricks
*/